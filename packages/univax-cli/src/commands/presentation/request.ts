...
export default class PresentationRequest extends Command {
  ...
  static examples = ['$ immu presentation:request -v verifierDID immunization,provider,site '];
  ...
  static args = [{name: 'credentialType', required: true, description: 'a comma separated list of claim names'}];
